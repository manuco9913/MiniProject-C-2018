...
namespace DS
{
    public class DataSource
    {
        ...
        static public List<Trainee> traineeInitList()
        {
            ...
            {
            new Trainee { _firstName = "As", _lastName = "Er", _numId="02345678", _address = "havaad 21", _dateOfBirth = "13/07/1999", _gender=Gender.M, _phoneNum="053-1234567", _whichCarUsed="B",_lessonsCount=5, _myTesterName="Manu", _schoolName=SchoolName.OZ, _typeOfGearbox="manual" },
            new Trainee { _firstName = "Angus", _lastName = "Brother", _numId="03456789", _address = "via alciati 22", _dateOfBirth = "13/07/1840", _gender=Gender.M, _phoneNum="053-2345678", _whichCarUsed="C",_lessonsCount=4, _myTesterName="Aviad", _schoolName="driverToBe", _typeOfGearbox="automatic" },
            new Trainee { _firstName = "Rosa", _lastName = "Rossi", _numId="07654321", _address = "ben yehuda 2", _dateOfBirth = "13/07/1399",  _gender=Gender.F, _phoneNum="051-2345678", _whichCarUsed="A" ,_lessonsCount=3, _myTesterName="Manu", _schoolName="driveLessons", _typeOfGearbox="manual"}
            };
        }
